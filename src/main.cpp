...
// Camera
const glm::vec3 cameraFollowVec(-4.0f, 6.3f, 0.0f);
...
int main(int argc, const char **argv) {
    ...
    if (FULLSCREEN) {
        ...
        for (int i = 0; i < modeCount; ++i) {
            if (modes[i].width > viewportWidth) {
                viewportWidth = modes[i].width/2;
                viewportHeight = modes[i].height/2;
            }
        }
    }
    ...
    Shader blurShader = Shader::create("shaders/basicer_shader.vert", "shaders/blur_shader.frag");
    Shader basicerShader = Shader::create("shaders/basicer_shader.vert", "shaders/basicer_shader.frag");
    Shader sceneDrawShader = Shader::create("shaders/basicer_shader.vert", "shaders/texture_merge_shader.frag");
    Shader simpleDepthShader = Shader::create("shaders/depth_shader.vert", "shaders/depth_shader.frag");
...

    {
        ...
        texturesToLoad.emplace_back(texUnit_impactSpriteSheet, "assets/models/bullet/Textures/impact_spritesheet_with_00.png");
        texturesToLoad.emplace_back(texUnit_muzzleFlashSpriteSheet, "assets/models/bullet/Textures/muzzle_spritesheet.png");
        texturesToLoad.emplace_back(texUnit_bullet, "assets/models/bullet/Textures/BulletTexture.png");
        texturesToLoad.emplace_back(texUnit_wigglyBoi, "assets/models/bullet/Textures/BulletTexture.png");
        texturesToLoad.emplace_back(texUnit_floorNormal, "assets/models/bullet/Textures/floor.png");
        texturesToLoad.emplace_back(texUnit_floorDiffuse, "assets/models/bullet/Textures/floor.png");
        texturesToLoad.emplace_back(texUnit_floorSpec, "assets/models/bullet/Textures/floor.png");
        texturesToLoad.emplace_back(texUnit_gunNormal, "assets/models/Player/Textures/Gun_NRM.tga");
        texturesToLoad.emplace_back(texUnit_playerNormal, "assets/models/Player/Textures/Player_NRM.tga");
        texturesToLoad.emplace_back(texUnit_gunDiffuse, "assets/models/Player/Textures/Gun_D.tga");
        texturesToLoad.emplace_back(texUnit_playerEmission, "assets/models/Player/Textures/Player_E.tga");
        texturesToLoad.emplace_back(texUnit_playerSpec, "assets/models/Player/Textures/Player_M.tga");
        texturesToLoad.emplace_back(texUnit_gunEmission, "assets/models/Player/Textures/Gun_E.tga");
        texturesToLoad.emplace_back(texUnit_playerDiffuse, "assets/models/Player/Textures/Player_D.tga");
        texturesToLoad.emplace_back(texUnit_gunSpec, "assets/models/Player/Textures/Gun_M.tga");
    ...
    char* data = (char*) "assets/models/Player/Player.fbx";
    ...
    Shader basicTextureShader = Shader::create("shaders/basic_texture_shader.vert", "shaders/floor_shader.frag");
    ...
    Shader instancedTextureShader = Shader::create("shaders/instanced_texture_shader.vert", "shaders/basic_texture_shader.frag");
    Shader nodeShader = Shader::create("shaders/redshader.vert", "shaders/redshader.frag");
    nodeShader.use();
    ...
    Shader spriteShader = Shader::create("shaders/geom_shader2.vert", "shaders/sprite_shader.frag");
    spriteShader.use();
    ...
    Shader textureShader = Shader::create("shaders/geom_shader.vert", "shaders/texture_shader.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        const glm::mat4 viewTransform = glm::lookAt(cameraPos, playerPosition, cameraUp);
        ...
        const glm::vec3 projectileSpawnPoint = playerModelTransform * glm::vec4(-20.0f, playerModelGunHeight,playerModelGunMuzzleOffset, 1.0f);
