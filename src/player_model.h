...
private:
  ...
  void processNode(int* meshesProcessed, bool isMeasuredFrame, aiNode *node, const aiScene *scene, int depth,std::unordered_map<std::string, aiMatrix4x4> &);
  PlayerMesh processMesh(bool isMeasuredFrame, aiMesh *mesh, const aiScene *scene,std::unordered_map<std::string, aiMatrix4x4> &);
